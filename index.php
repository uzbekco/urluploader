...
$url = $telegram['message']['text'];
 ...
 if($url == "/start"){
  ...
  'sendMessage', [
   'chat_id'=> $user_id,
   'text'=> '🎉Hammaga Assolumu Aleykum. Bu bot Fayl linkini yuklab beradi🙊 Bizning uchun botga yuklab olmoqchi bo'lgan ssilkangizni tashlang🌕🙃Bot 1GB Dan ortig'ini yuklamaydi 🌕Kanal @Hacker_Bey 👨🏻‍💻Dasturchi @Shox_Xacker',
  ]);  
 }else{
